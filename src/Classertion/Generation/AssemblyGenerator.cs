...
namespace Classertion.Generation
{
    ...
    internal class AssemblyGenerator : IAssemblyGenerator
    {
        ...
        public CSharpCompilation CompileAssembly<T>(IClassert<T> target, CompilationUnitSyntax compilation, ImmutableArray<string> namespaces) where T : class
        {
        ...
        public NamespaceDeclarationSyntax GetNamespaceDeclarations<T>(IClassert<T> target) where T : class
        {
            return sf.NamespaceDeclaration(sf.ParseName("ClassertGenerated"))
                .AddUsings(
        ...
        public IEnumerable<MetadataReference> LoadAssemblyReferenceses<T>(IClassert<T> target) where T : class
        {
        ...
        public ClassDeclarationSyntax GetClassDeclaration<T>(IClassert<T> target) where T : class
        {
        ...
        public ClassDeclarationSyntax ImplementatInterfaces<T>(IClassert<T> target, ClassDeclarationSyntax classDeclaration) where T : class
        {
        ...
        private ClassDeclarationSyntax InheritClass<T>(IClassert<T> target, ClassDeclarationSyntax result) where T : class
        {
        ...
        private BlockSyntax BuildConstructorBody<T>(IClassert<T> target, ConstructorInfo constructor) where T : class
        {
            return sf.Block();
        }

        private ConstructorDeclarationSyntax BuildConstructorSignature<T>(IClassert<T> target, ConstructorInfo constructor) where T : class
        {
